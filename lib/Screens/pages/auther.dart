...
// create a liat of book models from fire store  query snapshot
            List<autherModel> authers = snapshot.data!.docs
                .map((e) => autherModel.fromMap(e.data()))
                .toList();
              ...
              child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        Get.to(() => ShowAutherDetails(
                              autherDescription:
                                  authers[index].autherDescribtion,
                              autherImage: authers[index].autherImage,
                              authername: authers[index].auther,
                            ));
                      },
                      child: Card(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  ...
                                  fit: BoxFit.fill,
                                  image:
                                      NetworkImage(authers[index].autherImage),
                                ),
                              ),
                              // child: CircleAvatar(
